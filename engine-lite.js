...
class ERoot extends HTMLElement {
	connectedCallback() {
		game = this;
...
class EScene extends HTMLElement {
	setActive(flag) {
...
class EChoice extends HTMLElement {
	connect(callback) {
...
class EData extends HTMLElement {
	connectedCallback() {
...
document.addEventListener("DOMContentLoaded", () => {
	...
	c.define("s-if", EIf);
	c.define("s-data", EData);
	c.define("s-choice", EChoice);
	c.define("s-scene", EScene);
	c.define("s-root", ERoot);
});
